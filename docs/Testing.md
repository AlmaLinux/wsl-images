...
A WSL distribution manifest file `test_manifest.json` can be created either using the `tests/generate_manifest.py` or manually editing the template files `tests/test_manifest_[8-9.json.tpl`.
