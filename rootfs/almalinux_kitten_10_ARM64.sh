...
cp -v wsl_kitten_10_ARM64_dir/blobs/sha256/"$rootfs" AlmaLinux-Kitten-10_ARM64_"${build_version}".tar.gz
cp -v wsl_kitten_10_ARM64_dir/blobs/sha256/"$rootfs" AlmaLinux-Kitten-10_ARM64_"${build_version}".wsl
