...
cp -v wsl_8_ARM64_dir/blobs/sha256/"$rootfs" AlmaLinux-8_ARM64_"${build_version}".tar.gz
cp -v wsl_8_ARM64_dir/blobs/sha256/"$rootfs" AlmaLinux-8_ARM64_"${build_version}".wsl
