...
cp -v wsl_10_x64_dir/blobs/sha256/"$rootfs" AlmaLinux-10_x64_"${build_version}".tar.gz
cp -v wsl_10_x64_dir/blobs/sha256/"$rootfs" AlmaLinux-10_x64_"${build_version}".wsl
